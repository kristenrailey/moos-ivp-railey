...
/*calcPerpIntercept(slope, midpt_r, midpt_z)
...
/*calcCircCenter_r(z_center, int_slope, int_b)
  Given intercepting bisector line, find circle center, know z-coord of center already*/
...
/*calcCircCenter_z()
  Calculate circle center z-coordinate, funciton of surface sound speed and gradient*/
double AcousticPath::calcCircCenter_z(){
  return -m_c_0/m_gradient;
}

/*calcRBisect
  Calculate the radius from finding the circle with the bisection method*/
...
/*calcNewCircCenter_r
  Recalculate circle center ,since R is invalid */
