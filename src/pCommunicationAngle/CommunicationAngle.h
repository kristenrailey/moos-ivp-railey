...
class CommunicationAngle : public CMOOSApp
{
 ...
 private: // State variables
    ...
    float m_midpt_r, m_midpt_z, m_int_slope, m_int_b, m_circ_z_center, m_circ_r_center, m_R_bisect, m_theta_src, m_theta_src_deg, m_R_new, m_r_src_new, m_circ_r_center_new;
